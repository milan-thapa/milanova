  ...
  return (
    <section className="relative py-20 sm:py-24 md:py-32 bg-black overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-10 text-center"
      >
        <motion.h2
        ...
        <motion.p
          variants={itemVariants}
          className="text-white/90 text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-8 leading-relaxed"
        >
